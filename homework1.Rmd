...
Game7 <-
  ...
  save(Game5,Game6,Game7,file="NBA1920Final567.Rda")
```
...
```{r ans13}
# G5TimeParsed
G5TimeParsed <- paste0(Game5Time[[1]],Game5Time[[2]])
...
```{r ans14}
# TpeJason
Game5Time2 <- mdy_hm("Oct.9th,2020,21:00",tz="America/New_York")
TpeJason <- with_tz(Game5Time2,tzone="Asia/Taipei")
```
...
```{r ans15}
# ParisLouis
ParisLouis <- with_tz(Game5Time2,tzone="Europe/Paris")+minutes(15)
